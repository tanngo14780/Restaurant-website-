    ...
    <div className='auth-wrapper'>
            <div className='auth-form'>
                <div className='auth-navigation'>
                    <div className='register-navigation' style={{ backgroundColor: "#F23E4D", fontWeight:  700 }}>
                        REGISTER
                    </div>
                    <div className='login-navigation' style={{ backgroundColor: "rgba(242, 62, 77, 0.57)", fontWeight: 300 }} onClick={() => navigate('/login')}>
                        LOG IN
                    </div>
                </div>
